...
import com.uteq.sistemas.ventasexpress.fragment.AdministradorBonificaciones;
 ...
 */
public class VendedorBonificacionAdapter extends RecyclerView.Adapter<VendedorBonificacionAdapter.ViewHolder> {

    Context context;
    List<Empleado> empleados;

    public VendedorBonificacionAdapter(Context context, List<Empleado> empleados) {
...
/*                     RutaClientesFragment fragment = new ClienteVistaFragment();
                     fragment.setArguments(b);
