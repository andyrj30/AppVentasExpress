...
import com.uteq.sistemas.ventasexpress.adapter.ListProductoAdapter;
 ...
 */
public class PedidoDetalleAgregarFragment extends Fragment implements Asynchtask {


    private LinearLayoutManager linearLayoutManager;
    private ArrayList<ListaProductos> productos;
    ...
    public PedidoDetalleAgregarFragment() {
    ...
    private void ConectWSProductos() {
        ...
        WebService ws = new WebService(Constants.WS_PRODUCTO, params, view.getContext(), (Asynchtask) PedidoDetalleAgregarFragment.this);
        ws.execute("");
    }
    ...
    public void processFinish(String result) throws JSONException {
        ...
        productos = ListaProductos.JsonObjectsBuild(objdataarray);
        ListProductoAdapter adapater = new ListProductoAdapter(view.getContext(),productos,idPedido,PedidoDetalleAgregarFragment.this);
