...
import com.uteq.sistemas.ventasexpress.fragment.PedidoDetalleAgregarFragment;
import com.uteq.sistemas.ventasexpress.fragment.PedidoDetalleFragment;
import com.uteq.sistemas.ventasexpress.model.ListaProductos;
...
public class ListProductoAdapter extends RecyclerView.Adapter<ListProductoAdapter.ViewHolder> implements Asynchtask {
    Context context;
    ...
    String id_pedido;
    PedidoDetalleAgregarFragment pedidoDetalleAgregarFragment;




    public ListProductoAdapter(Context context, List<ListaProductos> productos, String id_pedido, PedidoDetalleAgregarFragment pedidoDetalleAgregarFragment) {
        this.context = context;
        this.productos = productos;
        this.id_pedido = id_pedido;
        this.pedidoDetalleAgregarFragment = pedidoDetalleAgregarFragment;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final ListProductoAdapter.ViewHolder viewHolder = new ListProductoAdapter.ViewHolder(itemView);
