...
public class PedidoEditarProductoFragment extends Fragment implements Asynchtask  {
    ...
    public PedidoEditarProductoFragment() {
    ...
    private void ConectWSDetallePedido(String tipo) {
        ...
        WebService ws = new WebService(Constants.WS_PRODUCTO, params, view.getContext(), (Asynchtask) PedidoEditarProductoFragment.this);
        ws.execute("");
    }
