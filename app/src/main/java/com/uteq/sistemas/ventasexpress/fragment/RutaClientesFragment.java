 ...
 */
public class RutaClientesFragment extends Fragment implements Asynchtask {
    ...
    private void ConectWSClientesR() {
        ...
        WebService ws = new WebService(Constants.WS_CLIENTE, params, view.getContext(), (Asynchtask) RutaClientesFragment.this);
        ws.execute("");
    }
