...
import com.uteq.sistemas.ventasexpress.utils.route.Destination;
import com.uteq.sistemas.ventasexpress.utils.route.GA;
import com.uteq.sistemas.ventasexpress.utils.route.Population;
import com.uteq.sistemas.ventasexpress.utils.route.TSP_SA;
import com.uteq.sistemas.ventasexpress.utils.route.Tour;
...
public class MapsActivity extends FragmentActivity implements Asynchtask{
    ...
    private void ConectWSPedidos() {
        ...
        params.put("id_ruta", "1");
        WebService ws = new WebService(Constants.WS_CLIENTE, params, this, (Asynchtask) MapsActivity.this);
        ws.execute("");
    }
