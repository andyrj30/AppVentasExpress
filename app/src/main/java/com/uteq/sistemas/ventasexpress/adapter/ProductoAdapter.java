...
import com.uteq.sistemas.ventasexpress.fragment.PedidoEditarProductoFragment;
...
public class ProductoAdapter extends RecyclerView.Adapter<ProductoAdapter.ViewHolder> {
    ...
    public ProductoAdapter(Context context, List<Producto> productos, String idpedido) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_producto, parent, false);
        ...
        viewHolder.btnEditar.setOnClickListener( new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                fragment = new PedidoEditarProductoFragment();
