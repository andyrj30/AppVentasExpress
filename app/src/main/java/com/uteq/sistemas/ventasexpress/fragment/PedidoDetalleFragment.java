 ...
 */
public class PedidoDetalleFragment extends Fragment implements Asynchtask {
    ...
    private void ConectWSClientesR() {
        ...
        WebService ws = new WebService(Constants.WS_PEDIDO, params, view.getContext(), (Asynchtask) PedidoDetalleFragment.this);
        ws.execute("");
    }
    ...
    public void processFinish(String result) throws JSONException {
        ...
        productos = Producto.JsonObjectsBuild(obj.getJSONArray("detalle"));
